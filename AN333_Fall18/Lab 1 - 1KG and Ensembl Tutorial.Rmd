...
For this class, we will be using the most up-to-date version of the *Ensembl* human geneome browser, the **GRCh38.p12** browser. Today we will use *Ensembl* to look at our gene of interest, *UCP1*. 
<br>
...
<br>
<br>
The link to the data slicer is available here: <http://grch38.ensembl.org/Homo_sapiens/Tools/DataSlicer?db=core>. 
<br>
<br>
