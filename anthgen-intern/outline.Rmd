...
* **Fecal Metabarcoding Project**
Please review the [SMAGL Fecal DNA Extractions: QIAGEN Stool Kit 25FEB24](https://docs.google.com/document/d/1E6bTLR_c8ge6NCUmiqmiPIpWrof9RDYa98Jtfvj5Wlw/edit?usp=sharing) (request access if this is not accessible to you). Please copy this protocol to you lab notebook for the internship and make modifications to it there (NOT to the original document!).

We will walk through the protocols in lab this week in preparation for your performing extractions this week!
...
We'll walk through the **Quantitation Station** today, and run an example sample through the dsDNA protocol on the Quantus and the NanoDrop. You'll be responsible for quantitating your extractions when they are ready to do so!
...
#### Checking in on Extractions/Quantitation

##### Topics for Discussion

Today we'll do a debrief on extractions and quantitations, and discuss where we could improve our lab practice in anticipation of next week, when we'll go over PCR (which particularly requires strong sterile lab methods).

##### Lab Practicum

If we haven't already, we'll work on quantitating our newly-finished extractions, and will potentially help each other work on our clean/sterile lab techniques. We'll also gear up for PCR and gel electrophoresis for the coming weeks!
...
* [Chaves et al. 2006. Noninvasive genetic sampling of endangered muriqui (Primates, Atelidae): efficiency of fecal DNA extraction. *Genetics and Molecular Biology* 29(4)](https://www.scielo.br/j/gmb/a/JHZTbnTm56XCvJ7YhfLdCRc/?lang=en) 
...
We'll discuss the importance of PCR, and it's use in molecular genetics to isolate regions of interest for genetic analysis. We'll also discuss methods important to our own work - in particular the ups and downs of primers used for microbiome and metabarcoding research. Finally, we'll discuss designing our own primers, and what that may involve.

##### Lab Practicum

We'll go over basic PCR technique, including using the PCR hood, the importance of sterile techniques to PCR methods in particular, and the use of the thermocyclers.
...
* Strachan & Reed: pp. 170-174
* Jobling: pp. 98-100, 120
* [Palumbi et al. 2002. The Simple Fool's Guide to PCR. ](https://stacks.stanford.edu/file/druid:yh393jm6703/Simple_Fool%27s_Master%20PCR.pdf)
* [Lorenz. 2012. Polymerase chain reaction: Basic protocol plus troubleshooting and optimization strategies. *J Vis Exp* 63: PMC4846334. ](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4846334/)
* [BiteSizeBio. Published May 13, 2021. "What is PCR? The Beginner's Guide"](https://bitesizebio.com/19132/pcr-basics-what-is-pcr/)
...
We'll discuss gel electrophesis and its various uses in genetics - for our own part, we'll be particularly interested in its uses for confirming the effectiveness of our PCR methods.

##### Lab Practicum

We'll learn how to create an agarose gel for use in our BlueGel rigs, and run a preliminary gel on some previously-generated PCR products in the lab.
...
* [miniPcR bio. 2021. "What is Gel Electrophoresis?" YouTube.](https://www.youtube.com/watch?v=GUXKQBknYQo)
* [ThermoFisher Scientific. "Nucleic Acid Gel Elecrtophoresis Troubleshooting."](https://www.thermofisher.com/us/en/home/life-science/cloning/cloning-learning-center/invitrogen-school-of-molecular-biology/na-electrophoresis-education/na-electrophoresis-troubleshooting.html)

##### Project-Specific Readings

* **Fecal Metabarcoding Project**
    + [Rowe et al. 2021. Exploratory analysis reveals arthropod consumption in 10 lemur species using DNA metabarcoding. *American Journal of Primatology* 83(6): e23256.](https://onlinelibrary.wiley.com/doi/abs/10.1002/ajp.23256?casa_token=V4ha8XnB65UAAAAA%3ACyqSRqnZO0MLDltB5bgSGBdpT8tZFEXj2HpXM_gDK1JqFpy6ZaRoh7iaOsXYYNXFLG7JiM5f_9Ky)
    + [Schneider et al. 2023. Molecular assessment of dietary variation in neighbouring primate groups. *Methods in Ecology and Evolution* 14(8): 1925-1936.](https://besjournals.onlinelibrary.wiley.com/doi/full/10.1111/2041-210X.14078)
* **Fecal Microbiome Project**
    + [Cortes-Ortiz & Amato. 2021. Host genetics influence the gut microbiome. *Science* 373(6551): 159-160.](https://www.science.org/doi/full/10.1126/science.abj5287)
    + [Quiroga-Gonzalez et al. 2021. Monitoring the variation in the gut microbiota of captive woolly monkeys related to changes in diet during a reintroduction process. *Scientific Reports* 11: 6522.](https://www.nature.com/articles/s41598-021-85990-0)
...
#### Library Prep and Sequencing using the ONT MinION

##### Topics for Discussion

We'll discuss what MinION sequencing is, how it works, and the benefits and drawbacks of this particular sequencing platform, as well as how to prepare our samples for sequencing via the library prep process.

##### Lab Practicum

We'll work together to do our library preparation and be present while Mel Zarate walks us through our course sequencing reaction on the MinION Mk1B!
...
#### Digging in to our Sequencing Results

##### Topics for Discussion

We'll go over the results of our sequencing reaction, and various bioinformatic post-processing techniques necessary to make sense of our generated DNA sequences, including de-multiplexing, alignment, and ASV assignment.

##### Lab Practicum

Our lab practicum for this week will take place in the SMAGL computational lab.
...
### Other potentially interesting readings for those continuing with field-based lab work:

* [Menke et al. 2017. Home-Made Cost Effective Preservation Buffer Is a Better Alternative to Commercial Preservation Methods for Microbiome Research. *Front Microbiol* 8: 102.](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5281576/)
