...
To set up your Personal Access Token, log in to your ***GitHub*** account and go to *Settings*. In the *Settings* menu, scroll down and click on *Developer Settings*. Once there, use the menu to click on *Personal Access Tokens* > *Tokens (classic)*.
