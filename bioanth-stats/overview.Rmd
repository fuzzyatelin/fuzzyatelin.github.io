...
3. Programming homework sets associated with each [Module](https://fuzzyatelin.github.io/bioanth-stats/modules.html), **due Thursday at 8:00 pm to your assigned [peer commentary partner(s)](https://fuzzyatelin.github.io/bioanth-stats/peercommentary.html)**.
4. Respectful [**Peer Commentary**](https://fuzzyatelin.github.io/bioanth-stats/peercommentary.html) on homework coding, that puts into practice teamwork and pair programming practices discussed in class and in readings, **to be submitted to me by 5:00pm Sunday**.
5. One individual [**Analysis Replication Assignment**](https://fuzzyatelin.github.io/bioanth-stats/data-reanalysis-assignment.html) based on a published paper with a publicly available dataset, chosen in consultation with the instructor.  
6. One <b>group presentation and written R vignette</b> demonstrating the use of a particular statistical method chosen in consultation with the instructor (past examples available in the [Modules](https://fuzzyatelin.github.io/bioanth-stats/modules.html)). Group participation will be a large part of evaluation, and must also put into practice teamwork methods discussed in readings and class.
7. A final [**Self Evaluation**](https://fuzzyatelin.github.io/bioanth-stats/selfevaluation.html) written by *you* arguing for the grade you have earned through your progress and the quality of your work in the class.
</ol>
