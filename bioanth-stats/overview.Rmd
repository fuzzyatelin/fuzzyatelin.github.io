...
This course has been proposed as an addition to the **BU HUB** General Education Curriculum as **CAS AN/BI 588**. Associated with this proposal are several proposed Learning Outcomes for this course, including:
...
3. Programming homework sets associated with each [Module](https://fuzzyatelin.github.io/bioanth-stats/modules.html), **due Thursday at 8:00 pm to your assigned [peer commentary partner(s)](https://fuzzyatelin.github.io/bioanth-stats/peercommentary.html)** (20%).
4. Respectful [**Peer Commentary**](https://fuzzyatelin.github.io/bioanth-stats/peercommentary.html) on homework coding, that puts into practice teamwork and pair programming practices discussed in class and in readings, **to be submitted to me by 5:00pm Sunday** (10%).
...
6. One <b>group presentation and written R vignette</b> demonstrating the use of a particular statistical method chosen in consultation with the instructor (past examples available in the [Modules](https://fuzzyatelin.github.io/bioanth-stats/modules.html)). Group participation will be a large part of evaluation, and must also put into practice teamwork methods discussed in readings and class (20%).
...
<center><p><img src="https://www.safaribooksonline.com/library/cover/9781617291388/360h/" height="250" width="200"></p></center><br>
