...
- NOTE: I am currently running ***R*** version *4.2.0 "Vigorous Calisthenics"* in ***RStudio*** version *2023.06.0+421* on a Mac OS Big Sur v. 11.7.4. If you're running different versions, you may have a slightly different experience with the code!
