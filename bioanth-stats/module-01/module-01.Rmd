...
- NOTE: I am currently running ***R*** version *4.1.1 "Kick Things"* in ***RStudio*** version *1.4.1717* on a Mac. If you're running different versions, you may have a slightly different experience with the code!
