...
Peer Commentary for this week should focus on the code for the [Module 04](http://fuzzyatelin.github.io/bioanth-stats/module-04/module-04.html) **CHALLENGES**, and should also be pushed directly to your *AN588-Week-2-BUlogin* repo by the member of your Peer Group responsible for commenting on your Original Homework Code. Share your Original Homework Code by [adding your Peer Group (and your instructor) as 'Collaborators'](https://help.github.com/en/articles/inviting-collaborators-to-a-personal-repository) by 8:00 pm on Thursday, September 12th.
...
Your final assignment, due to me by 5:00 pm on September 15th, is to have in your *AN588-Week-2-BUlogin* repo only the following files:
<ol>
