...
<font size="+2"><b>Must be submitted for Peer Commentary by 8:00 pm Monday, September 13th.</b></font></center><br>

<center>

<font size="+2"><b>Peer Commentary and Final Homework DUE at 5:00 pm Thursday, September 16th.</b></font></center><br>
...
Once you've finished (or even better: as you save along the way), you must PUSH that file up to ***GitHub*** directly from ***RStudio*** (i.e., once pushed, it should be accessible in your *AN588-Week-2-BUlogin* repo on your ***GitHub*** account's website). Notes in [Module 03](http://fuzzyatelin.github.io/bioanth-stats/module-03/module-03.html) should help you accomplish this - and, of course, feel free to come see me for additional help during my office hours if you're having problems.

### Peer Commentary for Homework 01

Peer Commentary for this week should focus on the code for the [Module 04](http://fuzzyatelin.github.io/bioanth-stats/module-04/module-04.html) **CHALLENGES**, and should also be pushed directly to your *AN588-Week-2-BUlogin* repo by the member of your Peer Group responsible for commenting on your Original Homework Code. Share your Original Homework Code by [adding your Peer Group (and your instructor) as 'Collaborators'](https://help.github.com/en/articles/inviting-collaborators-to-a-personal-repository) by 8:00 pm on Monday, September 13th.
...
Your final assignment, due to me by 5:00 pm on Thursday, September 16th, is to have in your *AN588-Week-2-BUlogin* repo only the following files:
<ol>
1. Your Original Homework Code, including the five challenges you faced, as pushed to your repo by 8:00 pm on Monday, an R Markdown file named *BUlogin_OriginalHomeworkCode_01*.
