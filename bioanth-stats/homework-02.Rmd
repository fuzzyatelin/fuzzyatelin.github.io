...
Your final assignment, due to me by 5:00 pm on September 22nd, is to have in your *AN597-Week-3-BUlogin* repo only the following files:
<ol>
1. Your Original Homework Code, including the five challenges you faced, as pushed to your repo by 8:00 pm on Thursday, an R Markdown file named *BUlogin_OriginalHomeworkCode_02*.
...
3. Your Final Homework Code, which has taken into account any changes recommended from the Peer Commentary and notes, an R Markdown file named *BUlogin_FinalHomeworkCode_02*.
</ol>
