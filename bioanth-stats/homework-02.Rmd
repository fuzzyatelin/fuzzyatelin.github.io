...
<font size="+2"><b>Must be submitted for Peer Commentary by 8:00 pm Thursday, September 26th.</b></font>

</center><br>

<center>

<font size="+2"><b>Peer Commentary and Final Homework DUE at 5:00 pm Sunday, September 29th.</b></font>
...
Your final assignment, due to me by 5:00 pm on September 29th, is to have in your *AN597-Week-3-BUlogin* repo only the following files:
<ol>
1. The *FINAL PUSH* of your Original Homework Code, including the five challenges you faced, as pushed to your repo by 8:00 pm on Thursday, an R Markdown file named *BUlogin_OriginalHomeworkCode_02*.
2. The *FINAL PUSH* of the [Peer Commentary](https://fuzzyatelin.github.io/bioanth-stats/peercommentary.html) made on *your* code, an R Markdown file named *Peerlogin_PeerCommentary_BUlogin_02* or *PeerGroupX_PeerCommentary_BUlogin_02*.
3. The *FINAL PUSH* of your Final Homework Code, which has taken into account any changes recommended from the Peer Commentary and notes, an R Markdown file named *BUlogin_FinalHomeworkCode_02*.
</ol>

***

### [Homework 02 Solutions](https://fuzzyatelin.github.io/bioanth-stats/homework-02-key.html) will be posted on September 30th.
