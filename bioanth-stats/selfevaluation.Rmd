...
<center>
The following self evaluation is meant to guide you through a reflection on what you put into this course, and also what you got out it in return. Your self evaluation is *not* the place to criticize, evaluate, or thank the instructor (we already had a good conversation about that on the last day of class). This is about *you*. Unless otherwise noted, please answer each question in no more than *eight* sentences. At the end, I ask you to assign yourself a grade that you think is both a fair and honest reflection of your performance in the class given what was asked of you.
...
Please give me a bulleted/numbered list of each task you were asked to do for this course. Where relevant, please also link the file representing each task in your appropriate repo, to the bulleted entry for that task.<br><br><br><br><br><br>
