...
- GO TO: https://github.com/fuzzyatelin/fuzzyatelin.github.io/tree/master/AN597_Fall19/, select the **random-people.csv** file, then press the `RAW` button, highlight, and copy the text to a text editor and save it locally.
