...
- GO TO: https://github.com/fuzzyatelin/fuzzyatelin.github.io/tree/master/AN588_Fall21/, select the **random-people.csv** file, then press the `RAW` button, highlight, and copy the text to a text editor and save it to your Desktop.
...
```{r,eval=F,echo=F}
stringr::str_split(string=(gsub("[[:punct:]]","",ulysses)),pattern=" ",n=22)
```
