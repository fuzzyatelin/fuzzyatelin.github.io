...
- GO TO: https://github.com/fuzzyatelin/AN597_Fall17/, select the `.txt` version of *Country-Data-2016*, then press the `RAW` button, highlight, and copy the text to a text editor and save it locally. Do the same for the `.csv` version.
...
``` {r}
library(curl)
f <- curl("https://raw.githubusercontent.com/fuzzyatelin/AN597_Fall17/master/CPDS-1960-2014-reduced.csv")
...
``` {r}
f <- curl("https://raw.githubusercontent.com/fuzzyatelin/AN597_Fall17/master/CPDS-1960-2014-reduced.txt")
d <- read.table(f, header = TRUE, sep="\t", stringsAsFactors = FALSE)
head(d)
# returns a data frame
```
...
``` {r}
library(readr)
f <- "https://raw.githubusercontent.com/fuzzyatelin/AN597_Fall17/master/CPDS-1960-2014-reduced.csv"
d <- read_csv(f, col_names = TRUE)
head(d)
# returns a "tibble", a new version of a data frame
```
``` {r}
f <- "https://raw.githubusercontent.com/fuzzyatelin/AN597_Fall17/master/CPDS-1960-2014-reduced.txt"
