...
- [**Harmonic mean**](https://www.mathsisfun.com/numbers/harmonic-mean.html) = the reciprocal of the average of the reciprocals of a set of values.
- [**Geometric mean**](https://www.mathsisfun.com/numbers/geometric-mean.html) = a measure of central tendency for processes that are multiplicative rather than additive = the nth root of the product of the values (for the mathematically inclined, it also = the antilog of the averaged log values).
