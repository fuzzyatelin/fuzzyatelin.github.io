...
- **Statistic** = a measureable characteristic about a sample, in this case described by a function in relation to the data (e.g., the mean length of vervet monkey femora found at the American Museum of Natural History). This is also called an *estimator* in statistical parlance (as in, an estimate of some characteristic).
