...
* In the Zeberg & Pääbo (2020) paper, they focus on a linkage block around the SNP *rs11385942*, the minor allele of which has been found to be [associated with severe COVID-19 symptoms](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7315890/). Which genomic region is associated with increased severity of COVID-19 (please give a range in Mb)?  Name the genes found in this region.
...
* Create a VCF file of *SLC6A20* for *your* 1000 Genomes population, and re-run the linkage analysis from Module 3 with the COVID-19 risk SNP *rs11385942* in mind, using *D'*. Is it in linkage with our SNP of interest from the exam, *rs202158371*? How about the index allele chosen by Zeberg & Pääbo (2020), *rs35044562*? <br><br><br>
