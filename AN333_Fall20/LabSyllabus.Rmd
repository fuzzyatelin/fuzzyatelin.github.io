...
**Please download associated materials on Slack**

***

### [*Module 1: Accessing Human Candidate Gene Region Data* – *ACE2*](https://fuzzyatelin.github.io/AN333_Fall20/Lab1_Module.html)
**September 18**<br>

***

**Material covered**: Introduction to the *1000 Genomes Project* dataset, and tutorial on using *Ensembl* to access the 1000 Genomes dataset. For illustrative purposes, we’ll focus on the angiotensin-converting enzyme 2 (*ACE2*) gene, which codes for the key receptor the coronavirus SARS-CoV-2 uses to enter cells, leading to the disease known as COVID-19.<br><br>
**Readings**:<ul>
...
**Activities**: We’ll learn how to use the *Ensembl* database to navigate our candidate gene, *ACE2*, and find more information about it. [**Each student will be assigned a single 1000 Genomes sub-population**](https://fuzzyatelin.github.io/AN333_Fall20/1KG_SubPop_Fall2020.html) that they will look at over the course of the modules, and we will use the *Data Slicer* within *Ensembl* to download data for those populations into our *SCC* accounts.<br><br>
**Assignment**: Students must turn in a worksheet – with questions related to *ACE2* variation in humans and related to the downloaded dataset – the following Friday **Pre-Module Homework Assignment is due today.**<br><br>
...
<li>Learn about the role of *ACE2* variation in humans, and how it is implicated in SARS-CoV-2 infection, and its role in other bodily systems.</li>
...
### [*Module 2: ACE2 Variants and Hardy-Weinberg Equilibrium*](https://fuzzyatelin.github.io/AN333_Fall20/Lab2_Module.html)
**October 02**<br>
...
<li>[Benetti E, et al. ACE2 gene variants may underlie interindividual variability and susceptibility to COVID-19 in the Italian population. *European Journal of Human Genetics* ](https://www.nature.com/articles/s41431-020-0691-z)</li><br>
...
### [Homework for Module 2: DUE Friday, October 12th](https://fuzzyatelin.github.io/AN333_Fall20/Lab2_Homework.html)

***

### [*Module 3: Linkage Disequilibrium (LD) in ACE2*](https://fuzzyatelin.github.io/AN333_Fall20/Lab3_Module.html)
**October 12**<br>
...
**Activities**: We'll assess linkage disequilibrium across the *ACE2* locus using our datasets downloaded from *Ensembl*, with a focus on the SNPs that are defined in Ramos *et al*. (2012). We will then discuss what high linkage disequilibrium in our populations could mean regarding potential for selection having occurred within our populations.<br><br>
**Assignment**: Students must turn in a worksheet – with questions related to *ACE2* variation in humans and related to the downloaded dataset –  in class the following Friday. **Module 2 Homework Assignment is due today.**<br><br>
**Learning Outcomes**:<ul>
<li>Learn about the SNPs *rs4240157*, *rs6632680*, *rs1548474*, and *rs2048683* and their roles in COVID-19 severity.</li>
...
<li>Learn how to use *Ensembl* to look at long-distance LD between SNPs in *ACE2*, as well as for SNPs in other genes. 
</li>

***

### [Homework for Module 3: DUE Friday, October 19th](https://fuzzyatelin.github.io/AN333_Fall20/Lab3_Homework.html)
...
### [Homework for Module 4: DUE Friday, November 2nd](https://fuzzyatelin.github.io/AN333_Fall20/Lab4_Homework.html)
...
### [Homework for Module 5: DUE Friday, November 16th](https://fuzzyatelin.github.io/AN333_Fall20/Lab5_Homework.html)
...
### [Homework for Module 6: DUE Friday, November 16th](https://fuzzyatelin.github.io/AN333_Fall20/Lab6_Homework.html)
...
**Assignment**: Students must answer questions about a potential candidate gene of interest by the following Friday. **Module 5 Homework Assignment is due today.**<br><br>
**Learning Outcomes**:<ul>
