...
* What is the 500-bp window of the severe COVID-19 risk region that has the highest value for Tajima's D in your population?

* What is the functional annotation for the SNPs in this window?
...
* Upload the image of your 1) EHH and 2) Bifurcation diagram for a representative SNP from this window, or for a particularly interesting SNP in one of your significance windows based on potential functionality.
