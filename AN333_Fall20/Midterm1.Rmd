...
<ol>21. If a functional *SLC6A20* protein is necessary to stop a 'cytokine storm' from developing when infected with SARS-CoV-2, what kind of consequence does the minor allele code for? What does this mean for those that possess the minor allele during the COVID-19 pandemic? **(2 points)**</ol><br>
