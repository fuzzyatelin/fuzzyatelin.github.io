---
title: '**AN/BI333 Lab 1**<br>Accessing Human Candidate Gene Region Data – *UCP1*'
...
There's also a student-led **Biology/Bioinformatics Peer Coding Hour** here at BU, where undergraduate and graduate students help each other with bioinformatics and statistical coding issues. The Peer Coding Hour will have their first meet-and-greet (with free food!) of the semester on **TBA**. I recommend everyone join!<br>
...
<br>
<br>
The most up-to-date genomic alignments for the 1000 Genomes data are generated by and stored in *Ensembl*. *Ensembl* is a genome database that is maintained by the [European Bioinformatics Institute](https://www.ebi.ac.uk/), and houses genomic data for many different species. *Ensembl* also has several versions of each dataset, which are updated as new alignment information becomes available.<br>
...
As an exercise, find *your* population in this table. Make sure you can find the allele and genotype counts. This will come in handy when we do our [Hardy-Weinberg Lab](https://fuzzyatelin.github.io/AN333_Fall20/Lab2_Module.html). 
<br>
