...
* Imagine that gene map above represents *UCP1*. Based on the Rose et al. (2011) article, where on the map is the SNP A-3826G? How would the placement of this SNP affect *UCP1* phenotype?
