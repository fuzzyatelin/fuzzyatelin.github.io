...
* Take a look at **D'** LD matrix and various other outputs you created in Module 3 for *your* population. List the linkage block that each SNP of interest is a part of, and which SNPs are in LD with each other among our five SNPs of interest.
