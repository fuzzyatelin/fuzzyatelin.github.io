...
You may begin the exam when the submission link (below) becomes active at class time on **Friday, November 13**, and work on the exam until the link closes at midnight of the exam due date, **Friday, November 20**.<br>

*No late responses will be accepted!*<br><br>

<center>
### [Access the online interface to submit your Midterm 2 answers here.](https://forms.gle/roGNmMGmjMp8hoRP6)
</center><br>
...
All *SCC*-based files associated with exam analyses should be uploaded to your named a folder in the general *anth333* project space. Doing this will be part of the exam, and involves commands you've already learned and used in the context of class.<br>
...
<ol>1. Log in to your *SCC* working directory in the `anth333` project space. **(1 point)**<br><br>

<ol>2. In the directory *anth333*, you should already have a shared project space named after your BU login. In that directory, create a new directory named '**Midterm2**'. **(2 points)**</ol><br>
...
So far in our labs, we've been focusing on the human *TMPRSS2* gene in our own assigned *1000 Genomes Project* populations. To better demonstrate what we've learned, let's take a look at this gene in a novel population.<br><br>

Now, I'm already convinced that we all know how to properly download a dataset from *Ensembl*, so for this exam, please copy the data for the **Bengali in Bangladesh** population from the *SampleVCF* folder into your *Midterm2* folder. **(5 points)**<br><br>

HINT: We last did something like this in [Module 4](https://fuzzyatelin.github.io/AN333_Fall20/Lab4_Module.html)
...
For the next few questions, we'll interrogate the dataset we copied for the Bengali from Bangladesh population from the *1000 Genomes Project* dataset. Using the methods in [Module 3](https://fuzzyatelin.github.io/AN333_Fall20/Lab3_Module.html), create an LD heatmap for the Bengali from Bangladesh using the **D'** test statistic. <br>

<ol>9. Upload your *D'* heatmap for the Bengali from Bangladesh population **(10 points)**</ol><br>

<ol>10. Which of the SNPs of interest from the LD module (*rs2070788*, *rs383510*, *rs4816720*, *rs12329760*) are in linkage disequilibrium (LD > 0.8) in the Bengali from Bangladesh population? **(6 points)**</ol><br>
...
Imagine that we all, as a class, submitted samples to the Sensory Morphology and Anthropological Genomics Lab for sequencing of our individual *TMPRSS2* genes. For a 20-bp sequence, we get the following information regarding *segregating sites* in that region:<br><br> 
...
<ol>24. We also calculated Tajima's D, in a different and much faster way, in [Module 5](https://fuzzyatelin.github.io/AN333_Fall20/Lab5_Module.html). Calculate Tajima's D for the Bengali in Bangladesh population. **(5 points)**</ol><br>
...
<ol>26. Given the value of Tajima's D for the Bengali in Bangladesh, what kind of selection might be occurring around *TMPRSS2* in this population? **(2 points)**
