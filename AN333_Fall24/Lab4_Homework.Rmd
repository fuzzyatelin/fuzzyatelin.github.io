...
* Please take a screenshot or save a PNG or PDF file of the neighbor-joining tree for your population and upload it as part of your answer. Your file size must not exceed 10 MB. Think about the diversity you see in terms of *TMPRSS2*. If there was an unexpected amount of diversity in your population, what would that mean for *TMPRSS2*? For example, if there is a lot of diversity in your population, does that mean there is selection occurring?
...
* Take a look at the interactive phylogenetic trees on the Next Strain website for SARS-CoV-2. Explore the tree. What is the most deviated/changed viral sample? How many mutations from the original virus does it have? What country was it sampled in? When was it collected?
