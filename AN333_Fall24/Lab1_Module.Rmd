...
```{bash, eval = FALSE, echo = T, class.source="sccCode"}
vcftools --vcf /projectnb/anth333/username/UCP1_YRI_all.vcf --keep /projectnb/anth333/username/YRI.samples.list --recode --out /projectnb/anth333/username/UCP1_YRI
```
...
```{bash, eval = FALSE, echo = T, class.source="sccCode"}
tabix -h /projectnb/anth333/1KG_Chrom4/CCDG_14151_B01_GRM_WGS_2020-08-05_chr4.filtered.shapeit2-duohmm-phased.vcf.gz chr4:140559434-140568805 > /projectnb/anth333/[username]/UCP1_[POP]_all.vcf
```
...
```{bash, eval = FALSE, echo = T, class.source="sccCode"}
vcftools --vcf /projectnb/anth333/caschmit/UCP1_YRI_all.vcf --keep /projectnb/anth333/caschmit/YRI.samples.list --recode --out /projectnb/anth333/caschmit/UCP1_YRI
```
