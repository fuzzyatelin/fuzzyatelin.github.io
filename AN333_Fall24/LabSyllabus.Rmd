...
**Activities**: We'll assess linkage disequilibrium across the *UCP1* loci using our datasets downloaded from *EnsEMBL*, with a focus on the SNPs that are defined in Nishimura et al. (2017). We will then discuss what linkage disequilibrium values in our populations could mean regarding potential for selection having occurred within our populations.<br><br>
**Assignment**: Students must turn in homeowork – with questions related to *UCP1* variation in humans and related to the downloaded dataset –  online by the following Friday. **Module 2 Homework Assignment is due today.**<br><br>
**Learning Outcomes**:<ul>
<li>Learn about the SNPs *rs1800592* and *rs4240157* for *UCP1*, and their roles in human thermoregulation and metabolism.</li>
...
### [Homework for Module 3: DUE Monday, October 25th](https://fuzzyatelin.github.io/AN333_Fall20/Lab3_Homework.html)
...
### [Homework for Module 4: DUE Friday, November 8th](https://fuzzyatelin.github.io/AN333_Fall20/Lab4_Homework.html)
...
### [Homework for Module 5: DUE Friday, November 15th](https://fuzzyatelin.github.io/AN333_Fall20/Lab5_Homework.html)
...
### [Homework for Module 6: DUE Friday, November 22nd](https://fuzzyatelin.github.io/AN333_Fall20/Lab6_Homework.html)
