...
* Please download an extended version of the *UCP1* gene region that includes 5,000 bp up- and down-stream of the gene region for your assigned population (i.e., add 5000 to the end position of the gene, and subtract 5000 from the starting position), and name it UCP1_REGION. Of all the files generated, you should keep *ONLY the final VCF file*. Send the file to me via the homework interface.<br>
