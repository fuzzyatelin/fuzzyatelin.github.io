...
**To apply for a UROP project in SMAGL, we require you to have completed at least one semester of research on a volunteer basis in the lab, with a commitment of 10 hours per week. Attendance at lab meetings is mandatory but summer research negotiable during this period.**
...
* There is a limit to how many students a PI may sponsor for UROP funding. This limit is 2 students per PI per semester, but in certain semesters may be fewer.
...
* Students receiving academic credit for their research (e.g., [Honors Research](https://fuzzyatelin.github.io/smagl_student_guide/smagl_honors.html) or [Research for Credit](https://fuzzyatelin.github.io/smagl_student_guide/smagl_rescredit.html)) cannot simultaneously receive UROP funding
* International students receiving UROP funding *must* do their research work in the United States to receive funding.

UROP provides the following categories of Awards:

## Stipend Awards

Stipend awards are paid directly to the student as taxable income; the hourly rate will reflect the current state minimum wage. These include:

* **Student Research Award (SRA)**: full amount provided by UROP. 
Fall or Spring Semester may earn up to $750 for 5 hours per week.
Summer semester may earn up to $7,000 for 40 hours per week for a 10-week program.
* **Faculty Matching Grants (FMG)**: half provided by UROP, half by the faculty mentor. The SMAGL Schmitt Lab does not currently provide UROP-FMG.
...
Students may apply for different stipend amounts based on the approximate number of hours to be worked per week (note that, while the award is for the semester or summer, it is paid in weekly installments over a 10 week period):

**Fall or Spring Semester**:

* 5 hours = $750
* 8 hours = $1,200 (with FMG only)
* 10 hours = $1,500 (with FMG only)

**Summer (beginning 2026)**:

* 20 hours = $3,500
* 30 hours = $5,250
* 40 hours = $7,000 (note: if conducting fieldwork, the default commitment is 40 hours/week)


**Important Notes on Stipend Working Hours Stipulations**
...
* Any summer-funded UROP students working another job on campus must report this in their award acceptance paperwork.
* If you have questions about receiving UROP funding while working another job on campus, please contact the office to discuss this further.
...
# SMAGL Undergraduates Funded by these Awards

Just to illustrate that you *can* actually win these awards as a student in the SMAGL (and if you'd like to reach out to past winners to ask if you could potentially see their applications or hear about their experiences applying), the following are SMAGL undergraduates who have won the above awards <ins>current lab members are highlighted</ins>):

## Internal Awards

* **UROP (Fall/Spring)**: <ins>Jacob Bronstein</ins>, Tyler Crawford, Morgan Farrar (x 3), Gianna Grob, Stephanie Inga, Nicole Lukas (x 3), <ins>Rhoda Ndukwe</ins>, Stacy-Anne Parke (x 3), Marwa Sayed, Erica Sun, Dillon Travis (x 2)
* **UROP (Summer)**: Morgan Farrar, <ins>Matteo Finnerty</ins>, Reese Hotten-Somers (x 2), Nicole Lukas, Stacy-Anne Parke, Evan Razdan, Marwa Sayed, Sofia Weaver (x 2), <ins>Claire Zhang</ins>
* **Honors Research Travel Award**: <ins>Claire Zhang</ins>
* **Biology Undergraduate Travel Award**: Tennyson Cooper, Sofia Weaver
* **Harold C. Case Scholarship**: Reese Hotten-Somers
* **Dean Elsbeth Mellville Scholarship**: Becca DeCamp
* **Department of Anthropology Undergraduate Research/Scholarship Award**: Becca DeCamp, Morgan Farrar, Reese Hotten-Somers, Stacy-Anne Parke
* **Department of Biology Undergraduate Research Award**: Chloe Leaman

## External Awards

* **AABA IDEAS Scholarship**: Alex Ortiz Gimenez Zapiola, <ins>Rhoda Ndukwe</ins> (Runner-Up), Stacy-Anne Parke, Xaulanda Thorpe, Sofia Weaver
* **ASP Research Grant**: <ins>Matteo Finnerty</ins>, Sofia Weaver
* **Barry Goldwater Scholarship**: Sofia Weaver
* **Field Projects International Scholarship**: Alex Ortiz Gimenez Zapiola, Sofia Weaver
* **NSF REU**: <ins>Jacob Bronstein</ins>, Alex Ortiz Gimenez Zapiola, Will Pudlo, Dillon Travis
* **SICB Broadening Participation Professional Development Award**: Sofia Weaver
* **SMBE Undergraduate Award**: Reese Hotten-Somers
