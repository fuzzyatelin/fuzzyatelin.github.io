...
Here is an example of a notebook entry from Sofia Weaver's *RMarkdown*, or `Rmd` file, lab notebook (note that Sofia is titling the entry with the formatted date "251125", or November 25, 2025):
...
**4.** Complete all necessary calculations and plate maps **PRIOR** to beginning library prep! Calculations and plate maps can be found in the sheet template and Mel's 'dual index' and 'pre library prep - prep' documents, listed above.
