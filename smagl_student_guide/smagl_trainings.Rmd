...
# Biosafety Training and SciShield
...
All safety trainings are done through an online interface known as [**SciShield**](https://bu.scishield.com/). Once you’ve joined the lab, I will add your BU login to the SciShield lab page, at which point you will get an email notifying you of your addition. Log in to SciShield using your BU login and password, and it will take you to the lab page, where there will be notifications regarding which training modules you must complete to be in compliance.
...
*You will only be allowed to enter the wet lab once you’ve completed all trainings in SciShield!*
...
In addition to the above, you *must* conduct an orientation to the lab with your PI (that’s Prof. Schmitt!) before beginning work in the lab.
...
If you've already filled out your Assessment and nobody from ROHP has followed up, you have to email **ROHP[at]bu[dot]edu** to follow up yourself. I know it’s an added burden to keep track of this process yourself, particularly since when we don’t hear back we don’t know where they are in their own process, but that appears to be the current state of ROHP. To make it just a bit more confusing, keep in mind that emails from ROHP regarding your clearance may come from the Occupational Health email **ohcinfo[at]bu[dot]edu** instead of from the ROHP email address.  Again, Lab Coordinator Dr. Christian Gagnon can help with follow-up!
...
Please note for your ROHP paperwork that the Schmitt Lab has a few approved protocol numbers you may need to enter on your form so that ROHP is aware of the risks involved with your research activities. These include:

* **IBC: 22-2111** (this is for *all wet bench work in STO 251*, so if you’re doing wet bench work this semester you must list this!)
* **IACUC: PROTO201900027** (*only for field work with yellow-tailed woolly monkeys*: currently Evelyn, Matteo)
* **IACUC: PROTO20180061** (*only for field work with vervet monkeys in South Africa*: currently Jess, Claire)
 
If you have any questions, please contact Prof. Schmitt or Lab Coordinator Dr. Christian Gagnon.
