...
*This Graduate Student Compact is meant to serve as a broad set of guidelines for our student-advisor relationship. This document will be reviewed and signed at the start of each academic year along with the annual meeting documents required by Anthropology and Biology departments.*
...
*	**Applying for [funding](https://fuzzyatelin.github.io/smagl_student_guide/grad_funding.html) to support my research**. I understand that although the field and lab will help support/enable my research, I need to raise grant funding to support my own dissertation/thesis research.
*	**Discussing [policies on authorship](https://fuzzyatelin.github.io/smagl_student_guide/smagl_authorship.html) with my advisor**. I will work with my advisor to submit all relevant research results for publication in a timely manner prior to graduation.  If my results have not been submitted prior to graduation I will make a plan with my advisor for submission of these papers and will adhere to this plan. I will discuss with my advisor who else should be included on publications and abstracts before asking or including those individuals. I acknowledge that I have an obligation to my funders, collaborators and advisor to publish my dissertation work.
...
*	**Being knowledgeable of the [policies and requirements of my program](https://fuzzyatelin.github.io/smagl_student_guide/grad_programs.html), school, and institution**, and to meet these requirements, including teaching responsibilities. I will discuss with my advisor BU's and SMAGL's policies regarding ownership of data and research materials.
...
*	**Completing all required [Biosafety trainings and RCR modules](https://fuzzyatelin.github.io/smagl_student_guide/smagl_trainings.html)**. These are found at [**SciShield**](http://bu.scishield.com) and the [**RCR Page**](http://www.bu.edu/orc/programs-committees/rcr/).
...
*	**Presenting my work at scientific conferences**. I understand that students are normally expected to attend *at least one* (1) scientific conference each year. *From year 2 onward* I will plan to present a poster or paper for at least one meeting per year based on my research.
* **Being aware of the details of and any changes to my [BUGWU contract with BU](https://bugwu.org/for-members/current-contract-2024-2027/) and being an active member of my Union**. If you are a graduate student at BU receiving a stipend, you are a member of the [Boston University Graduate Student Union (BUGWU)](https://bugwu.org). A union can only help you insofar as *you help your fellow union members* to be aware of your needs and how they might best be met. This includes being aware of your formal [benefits](https://bugwu.org/for-members/benefits/) and of the process for filing formal [grievances](https://bugwu.org/for-members/grievances/) should your contracted rights be violated by the university.
...
*	**Acting as a good lab citizen**.  I will share in the responsibilities that involve data or samples that I am using or that I expect to use for my thesis/dissertation. These responsibilities may include data entry, data management, data cleaning, data copying, data scanning, dry lab organization, sample inventory, sample sorting, sample data entry, integration of my individual project data into the larger lab dataset *in a timely manner*, wet lab cleaning and organization.
...
*	**Being responsive**. I will respond promptly (in most cases, within 48 hours) to emails from anyone in our lab group and show up on time and prepared for meetings. If I need time to gather information in response to an email, I will acknowledge receipt of the message and indicate when I will be able to provide the requested information.
*	**Discussing policies on work hours, sick leave, and vacation with my advisor**. I will let my advisor know about any planned absences, both while in residence and while in the field. I understand that my advisor expects me to take time off to recharge and that they support this need. I also realize that my advisor will need to know if I won’t be available or, for safety purposes, if I’m not at the field site while conducting fieldwork. I will consult [BUGWU](https://bugwu.org) regarding the current [contracted agreement with BU](https://bugwu.org/for-members/current-contract-2024-2027/) regarding these policies if I am a union member.
*	**Seeking resolution if I am unhappy with my current advising experience**. Not all people can get along all the time; I agree to accept this, and to take responsibility for my own potential role in such dynamics. I also agree to follow best practices for resolution, which includes speaking to my advisor *first* if there is a disagreement or if I feel I have been treated unfairly in some way, with a good faith effort to resolve the situation. If that does not resolve the situation, I agree to approach either 1) my other internal committee members or 2) the Director of Graduate Studies of my respective department to help mediate. Ultimately, if these avenues do not appear to work, or if I feel uncomfortable with a one-on-one discussion of the issue, I agree to discuss the issue with a university Ombuds to attempt resolution.
...
*	**Supporting your research project**: I will work with you to help identify a promising research topic; help you to plan and direct the project, set reasonable and attainable goals, and establish a timeline for completion. After agreeing on a thesis/dissertation topic, I will strive to support your thesis/dissertation research project to the best of my ability.
*	**Providing Feedback**: I will provide constructive feedback on your project ideas and hypotheses, study design, and interpretation of data. My commentary will be aimed at helping you to develop the highest impact research that is both feasible in the lab, within my advising capabilities, and within your realm of interest. I will also provide feedback on your general progress in developing as a scientist and as a teacher.
...
*	**Providing advice and guidance on finding appropriate [grant/fellowship opportunities](https://fuzzyatelin.github.io/smagl_student_guide/grad_funding.html)** and provide constructive feedback on proposals/applications. 
*	**Providing and facilitating training** in skills needed to be a successful scientist in your chosen field and/or future profession, including oral and written communication, grant writing, lab management, animal and human research policies, ethical conduct, and scientific professionalism. 
*	**Helping you identify additional advisors, resources and opportunities** that will aid in your career development and training. These may include on-campus faculty or postdocs, external advisors at other universities, or NGO/industry professionals in your chosen field.
*	**Providing life-long career advising**, including education and training as a practicing scientist or in related career. Our relationship does *not* have to end once you graduate (but can if you prefer!).
...
*	**Discussing policies on work hours, sick leave, and vacation with you**. The [BU Graduate Workers Union (BUGWU)](https://bugwu.org) negotiates all policies on work hours, sick leave, and vacation for all graduate workers while you are on contract. As a faculty member, I cannot discuss BUGWU contract negotiations, nor do I have the power to intervene with the university or BUGWU if there is a contract dispute specific to your work or research. For my own part, I will let you know of my planned absences and travel dates, both while in residence and while in the field. 
...
*	**Providing career advice and assisting you in finding a position following graduation**; I will provide [letters of recommendation](https://fuzzyatelin.github.io/smagl_student_guide/smagl_letter.html) for your next phase of professional development that are honest and objective, and I will continue to be accessible and give advice and feedback on career goals. 
*	**Creating an encouraging and supportive scientific environment**; I view my role as fostering your professional development and encouraging critical thinking and creativity. I will try my best to understand your unique situation, and mentor you accordingly, and [to build an environment in which you can thrive](https://fuzzyatelin.github.io/smagl_student_guide/smagl_conduct.html). I am mindful that each student comes from a different background and has different professional goals. It will help if you keep me informed about your experiences and remember that graduate school is a job with very high expectations. If my attempts to do this are not effective for you, I am open to talking with you about other ways to achieve these goals.
*	**Helping you navigate your [graduate program](https://fuzzyatelin.github.io/smagl_student_guide/grad_programs.html) of study**. Remember that all of us are “new” at various points in our careers. If you feel uncertain, overwhelmed, or want additional support, please explicitly ask for it. I welcome these conversations and view them as necessary.
...
**Rather than signing this compact, when you've finished reading it please write me an email affirming that you've read and agree to the compact with at least one question about the contents and how they apply to you, and/or one suggestion for improving the compact for future graduate students.**
